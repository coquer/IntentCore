 ...
 * <!-- end-user-doc -->
 * @see intent.IntentPackage#getIntentType()
 * @model
 * @generated
 */
public enum IntentType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IntentType[] VALUES_ARRAY =
		new IntentType[] {
			STANDARD,
			BROADCAST,
		};
	 ...
	 * @generated
	 */
	public static IntentType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IntentType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static IntentType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private IntentType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
